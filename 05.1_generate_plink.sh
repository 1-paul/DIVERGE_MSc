...
/share/apps/plink-1.90-beta-6.10/plink --bfile DIVERGE_QCed_initial --remove "$removed_relatives" --make-bed --out DIVERGE_QCed1 --allow-extra-chr

###removing close relatives here
/share/apps/plink-1.90-beta-6.10/plink --bfile DIVERGE_QCed1 --remove "$sex_mismatch" --make-bed --out DIVERGE_QCed2 --allow-extra-chr
...
##convert to plink2
/share/apps/genomics/plink-2.0/bin/plink2 --bfile DIVERGE_QCed2 --make-pgen --out DIVERGE_QCed
